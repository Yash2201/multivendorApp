...
<div class="__inline-9 rtl">
        ...
        <div class="max-w-1160px mx-auto footer-slider-container">
            <div class="container">
                <div class="row g-4"
                    ...
                    <div
                        class="{{ Route::has('frontend.blog.index') && getWebConfig(name: 'blog_feature_active_status') ? 'col-6 col-md-3' : 'col-6 col-md-4' }}">
                        <div class="footer-slide-item">
                            <div>
                                <a href="{{ route('business-page.view', ['slug' => 'about-us']) }}">
                                    <div class="text-center text-white mb-lg-3 mb-2">
                                        <img class="object-contain svg" width="36" height="36"
                                            src="{{ theme_asset(path: 'public/assets/front-end/img/icons/about-us.svg')}}" alt="">
                                    </div>
                                    <div class="text-center">
                                        ...
                                        <p class="d-none d-sm-block des mb-0">{{
                                            translate('Know_about_our_company_more.') }}</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="footer-slide-item">
                            <div>
                                <a href="{{ route('contacts') }}">
                                    <div class="text-center text-white mb-lg-3 mb-2">
                                        <img class="object-contain svg" width="36" height="36"
                                            src="{{ theme_asset(path: 'public/assets/front-end/img/icons/contact-us.svg') }}" alt="">
                                    </div>
                                    <div class="text-center">
                                        <p class="m-0 mt-2">
                        ...
                        <div class="footer-slide-item">
                            <div>
                                <a href="{{ route('helpTopic') }}">
                                    <div class="text-center text-white mb-lg-3 mb-2">
                                        <img class="object-contain svg" width="36" height="36"
                                            src="{{ theme_asset(path: 'public/assets/front-end/img/icons/faq-icon.svg')}}" alt="">
                                    </div>
                                    <div class="text-center">
                                        <p class="m-0 mt-2">
                                            {{ translate('FAQ') }}
                        ...
                        <div class="footer-slide-item">
                            <div>
                                <a href="{{ route('frontend.blog.index') }}">
                                    <div class="text-center text-white mb-lg-3 mb-2">
                                        <img class="object-contain svg" width="36" height="36"
                                            src="{{ theme_asset(path: 'public/assets/front-end/img/icons/blog-icon.svg')}}" alt="">
                                    </div>
                                    <div class="text-center">
                                        <p class="m-0 mt-2">
                                            {{ translate('Blog') }}
    ...
    <footer class="page-footer font-small rtl">
        <div class="pt-4">
            <div class="container text-center __pb-13px">
                ...
                <div class="row mt-3 pb-3 ">
                    <div class="col-md-3 footer-web-logo text-center text-md-start ">
                        ...
                        (isset($web_config['android']['status']) && $web_config['android']['status']))
                        <div class="mt-4 pt-lg-4">
                            <h6
                                class="text-uppercase font-weight-bold footer-header align-items-center text-center text-md-start">
                        ...
                        <div class="row">
                            <div class="col-sm-3 col-6 footer-padding-bottom text-start">
                                ...
                                <ul class="widget-list __pb-10px">
                                    ...
                                    @endif
                                    <li class="widget-list-item">
                                        <a class="widget-list-link" href="{{ route('featured-products') }}">
                                            {{ translate('featured_products') }}
                                        </a>
                                    </li>
                                    <li class="widget-list-item">
                                        <a class="widget-list-link" href="{{ route('best-selling-products') }}">
                                            {{ translate('best_selling_product') }}
                                        </a>
                                    </li>
                                    <li class="widget-list-item">
                                        <a class="widget-list-link" href="{{ route('latest-products') }}">
                                            {{ translate('latest_products') }}
                                        </a>
                                    </li>
                                    <li class="widget-list-item">
                                        <a class="widget-list-link" href="{{ route('top-rated-products') }}">
                ...
                <div class="row g-4 {{Session::get('direction') === " rtl" ? ' flex-row-reverse' : '' }}">
                    <div class="col-xl-5 col-md-6">
                        <div
                            ...
                            <div class="">
                                <span class="mb-4 font-weight-bold footer-header text-capitalize">{{
                                    translate('start_a_conversation') }}</span>
                            </div>
                            <div class="flex-grow-1 d-none d-md-block {{Session::get('direction') === " rtl" ? 'me-2 '
                                : 'ml-2' }}">
                                <hr>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3">
                        <div class="max-sm-100 justify-content-center d-flex flex-wrap mt-md-3 mt-0 mb-md-3">
                            ...
                            <span class="social-media ">
                                ...
                                @else
                                <a class="social-btn text-white sb-light sb-{{ $item->name }} me-2 mb-2" target="_blank"
                                    href="{{ $item->link }}">
        ...
        <div class="footer-bottom-dark py-4">
            <div class="container">
                <div class="row">
                    <div class="col"></div>
                    <div class="col-md-10">
                        <div class="d-flex flex-column gap-3">
                            ...
                            <ul
                                class="d-flex fs-12 flex-wrap flex-column flex-sm-row justify-content-center align-content-center gap-2 column-gap-4 mb-0 p-0">
