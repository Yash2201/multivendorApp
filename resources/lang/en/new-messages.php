...
return [
	...
	"method_name_field_is_required" => "Method name field is required",
	"input_Field_Type" => "Input Field Type",
	"input_field_type_is_required" => "Input field type is required",
	"string" => "String",
	...
	"Captcha_check_failed_:_hostname_match_not_found" => "Captcha check failed : hostname match not found",
	...
	"Category_" => "Category ",
	"invalid_json_payload_received._unknown_name_code:_proto_field_is_not_repeating,_cannot_start_list." => "Invalid json payload received. unknown name code: proto field is not repeating, cannot start list.",
	"Out_of_Stock" => "Out of Stock",
	"Join_Date" => "Join Date",
	...
	"title_may_not_be_greater_than_51_characters" => "Title may not be greater than 51 characters",
	...
	"title_must_not_exceed_51_characters" => "Title must not exceed 51 characters",
	"sub_title_must_be_string" => "Sub title must be string",
	"sub_title_must_not_exceed_161_characters" => "Sub title must not exceed 161 characters",
	"section_1_title_is_required" => "Section 1 title is required",
	"section_1_title_must_be_string" => "Section 1 title must be string",
	"section_1_title_must_not_exceed_51_characters" => "Section 1 title must not exceed 51 characters",
	"section_1_description_is_required" => "Section 1 description is required",
	"section_1_description_must_be_string" => "Section 1 description must be string",
	"section_1_description_must_not_exceed_161_characters" => "Section 1 description must not exceed 161 characters",
	"section_1_image_must_be_an_image" => "Section 1 image must be an image",
	"section_1_image_invalid_format" => "Section 1 image invalid format",
	"section_1_image_must_not_exceed_2mb" => "Section 1 image must not exceed 2mb",
	"section_2_title_is_required" => "Section 2 title is required",
	"section_2_title_must_be_string" => "Section 2 title must be string",
	"section_2_title_must_not_exceed_51_characters" => "Section 2 title must not exceed 51 characters",
	"section_2_description_is_required" => "Section 2 description is required",
	"section_2_description_must_be_string" => "Section 2 description must be string",
	"section_2_description_must_not_exceed_161_characters" => "Section 2 description must not exceed 161 characters",
	"section_2_image_must_be_an_image" => "Section 2 image must be an image",
	"section_2_image_invalid_format" => "Section 2 image invalid format",
	"section_2_image_must_not_exceed_2mb" => "Section 2 image must not exceed 2mb",
	"section_3_title_is_required" => "Section 3 title is required",
	"section_3_title_must_be_string" => "Section 3 title must be string",
	"section_3_title_must_not_exceed_51_characters" => "Section 3 title must not exceed 51 characters",
	"section_3_description_is_required" => "Section 3 description is required",
	"section_3_description_must_be_string" => "Section 3 description must be string",
	"section_3_description_must_not_exceed_161_characters" => "Section 3 description must not exceed 161 characters",
	"section_3_image_must_be_an_image" => "Section 3 image must be an image",
	"section_3_image_invalid_format" => "Section 3 image invalid format",
	"section_3_image_must_not_exceed_2mb" => "Section 3 image must not exceed 2mb",
	"download_app_title_is_required" => "Download app title is required",
	"download_app_title_must_be_a_string" => "Download app title must be a string",
	"download_app_title_max_character_is_50" => "Download app title max character is 50",
	"download_app_subtitle_is_required" => "Download app subtitle is required",
	"download_app_subtitle_must_be_a_string" => "Download app subtitle must be a string",
	"download_app_subtitle_max_character_is_160" => "Download app subtitle max character is 160",
	"google_play_link_is_required" => "Google play link is required",
	"google_play_link_must_be_a_valid_string" => "Google play link must be a valid string",
	"apple_store_link_is_required" => "Apple store link is required",
	...
	"pay_SenxC2p9jaz477" => "Pay SenxC2p9jaz477",
	"Payment" => "Payment",
	"Reference_Code" => "Reference Code",
	...
	"Download_the_format_file_to_get_the_required_column_structure." => "Download the format file to get the required column structure.",
	...
	"The_method_name_field_is_required." => "The method name field is required.",
	"The_field_type_field_is_required." => "The field type field is required.",
	"The_field_type_must_be_an_array." => "The field type must be an array.",
	"The_field_name_field_is_required." => "The field name field is required.",
	"The_field_name_must_be_an_array." => "The field name must be an array.",
	"The_placeholder_text_field_is_required." => "The placeholder text field is required.",
	"The_placeholder_text_must_be_an_array." => "The placeholder text must be an array.",
	"The_is_required_field_must_be_a_boolean_value." => "The is required field must be a boolean value.",
	"The_is_default_field_must_be_either_0_or_1." => "The is default field must be either 0 or 1.",
	...
	"Shiprocket_Shipping" => "Shiprocket Shipping",
	"Package_Weight" => "Package Weight",
	"Length" => "Length",
	"Breadth" => "Breadth",
	"Height" => "Height",
	"Pickup_Pincode" => "Pickup Pincode",
	"Your_warehouse_pincode" => "Your warehouse pincode",
	"Pickup_Location" => "Pickup Location",
	"Primary" => "Primary",
	"Create_shipment_via_Shiprocket?" => "Create shipment via Shiprocket ",
	"Ship_via_Shiprocket" => "Ship via Shiprocket",
	"shipment_creation_failed" => "Shipment creation failed",
	"Are_you_sure_you_want_to_create_shipment_via_Shiprocket?" => "Are you sure you want to create shipment via Shiprocket ",
	...
	"Cannot_remove_all_product_from_list" => "Cannot remove all product from list",
	"successfully_canceled" => "Successfully canceled",
	"Shiprocket_shipping_is_available_for_confirmed_or_processing_orders" => "Shiprocket shipping is available for confirmed or processing orders",
	"Address_Type" => "Address Type",
	...
	"10_digit_mobile" => "10 digit mobile",
	"Address_Line" => "Address Line",
	"Address_Line_2" => "Address Line 2",
	"State" => "State",
	"Pincode" => "Pincode",
	"6_digit_pincode" => "6 digit pincode",
	"Save_Address" => "Save Address",
	"No_pickup_address_yet_add_one_to_continue" => "No pickup address yet add one to continue",
	"Set_default" => "Set default",
	"Failed_to_load_pickup_addresses" => "Failed to load pickup addresses",
	"Are_you_sure_you_want_to_delete_this_pickup_address?" => "Are you sure you want to delete this pickup address ",
	"Something_went_wrong" => "Something went wrong",
	"the_pickup_contact_name_is_required" => "The pickup contact name is required",
	"the_email_is_required" => "The email is required",
	"the_phone_is_required" => "The phone is required",
	"phone_must_be_a_valid_10_digit_mobile_number" => "Phone must be a valid 10 digit mobile number",
	"the_address_is_required" => "The address is required",
	"the_city_is_required" => "The city is required",
	"the_state_is_required" => "The state is required",
	"the_country_is_required" => "The country is required",
	"the_pincode_is_required" => "The pincode is required",
	"pincode_must_be_a_valid_6_digit_pincode" => "Pincode must be a valid 6 digit pincode",
	"Please_correct_the_highlighted_fields" => "Please correct the highlighted fields",
	"pickup_address_added_successfully" => "Pickup address added successfully",
	...
	"Nickname" => "Nickname",
	"Actions" => "Actions",
	"e.g._12,_MG_Road" => "E.g. 12, MG Road",
	"pickup_address_deleted" => "Pickup address deleted",
	"default_pickup_address_updated" => "Default pickup address updated",
	"Shiprocket_Pickup_Addresses" => "Shiprocket Pickup Addresses",
	"Name,_city,_pincode_or_shop" => "Name, city, pincode or shop",
	"All_vendors" => "All vendors",
	"Assign_to" => "Assign to",
];
